...
export declare const NONE_KIND = "None";
/** Default label rendered before the current kind. */
export declare const DEFAULT_SEGMENTS_LABEL = "Segment";
/** Default app_key when the host does not supply `uiElement.app_key`. */
export declare const DEFAULT_APP_KEY = "data_report_segmenter";
/** App name — used for report filenames. */
export declare const APP_NAME = "data_report_segmenter";
/** dv-rpc channel the processor subscribes to. */
export declare const RPC_CHANNEL = "dv-rpc";
/** Channel carrying the generated-report job messages. */
export declare const REPORTS_CHANNEL = "segment_reports";
